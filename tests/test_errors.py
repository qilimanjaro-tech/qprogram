...
def test_validation_error_not_a_value_error_by_default():
    # The base ValidationError does not extend ValueError; only
    # InvalidVariableIdError and UnassignedVariableError do, so those two
    # can also be caught as ValueError.
