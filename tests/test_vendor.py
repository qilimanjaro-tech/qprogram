...
"""Tests for the :class:`~qprogram.vendor.VendorNamespace` base class."""
...
# A minimal vendor op set, reached through a namespace the fixtures below register temporarily.
